...
export class CertificateComponent implements OnInit {
    ...
    showLink(courseID: Number) {
      ...
      //  /certificate/certgeneratorlog/
       // this.http.get('http://localhost:9000/certificate/studentInfo/certgeneratorlog/' + this.studID) //querystring.stringify({'courseURL':JSON.stringify(this.courseURL)}
       ...
       // this.courseURL
        ...
        console.log(this.certificateList[0]);
        console.log("succesfully got URL");
    ...
    deleteUser(courseID: Number) { //added this

        //alert("StudentID: "+ this.studID);
        //alert("Delete courseID: "+ courseID);
